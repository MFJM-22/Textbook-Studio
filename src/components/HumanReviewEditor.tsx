  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-100 flex flex-col">
      ...
      <div className="bg-slate-950 border-b border-slate-800 px-6 py-4 flex items-center justify-between sticky top-0 z-30">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 rounded text-xs font-bold bg-purple-900/60 text-purple-300 border border-purple-700/50">
                Human Review Gate
              </span>
              <h2 className="text-base font-bold text-white">{book.title}</h2>
            </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2 text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-500 rounded-lg shadow-lg shadow-emerald-600/20 transition-colors"
          >
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-72 bg-slate-950 border-r border-slate-800 p-4 flex flex-col justify-between overflow-y-auto">
          <div>
