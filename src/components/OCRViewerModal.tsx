    ...
    <div className="fixed inset-0 z-50 bg-slate-900/70 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-5xl h-[85vh] flex flex-col overflow-hidden border border-slate-200">
        ...
        <div className="flex items-center justify-between px-6 py-4 bg-slate-900 text-white flex-shrink-0">
          <div>
            <div className="flex items-center gap-2">
              <span className="text-xs font-semibold px-2 py-0.5 rounded bg-blue-900 text-blue-300 border border-blue-700/50">
                OCR Processing
              </span>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2 bg-purple-600 hover:bg-purple-500 text-white rounded-lg text-xs font-bold shadow-md shadow-purple-600/20 transition-colors"
            >
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-56 bg-slate-50 border-r border-slate-200 p-3 overflow-y-auto space-y-2 flex-shrink-0">
            ...
            {pages.map((p, idx) => (
              ...
              >
                <div className="w-10 h-12 bg-slate-200 rounded overflow-hidden flex-shrink-0 border border-slate-300">
                  <img
                    src={p.image_url}
