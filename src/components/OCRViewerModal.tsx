...
export const OCRViewerModal: React.FC<OCRViewerModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-2 sm:p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-6xl h-[90vh] flex flex-col overflow-hidden border border-slate-200/80">
        {/* Header Bar */}
        <div className="flex items-center justify-between px-4 sm:px-6 py-3.5 bg-slate-50/90 text-slate-900 shrink-0 flex-wrap sm:flex-nowrap gap-2 border-b border-slate-200/80">
          <div className="flex items-center gap-3">
            <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full bg-indigo-50 text-indigo-700 border border-indigo-200/60">
          ...
          <div className="flex items-center gap-2 shrink-0 ml-auto">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full text-xs font-bold shadow-xs transition-all min-h-[38px] disabled:opacity-50"
            >
                ...
                <div className="flex items-center justify-between pb-2 border-b border-slate-100">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      disabled={isReOCRing}
                      className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-slate-700 bg-slate-100 hover:bg-slate-200/80 rounded-full transition-colors"
                      title="Re-run Gemini Vision OCR on this page"
                    >
                      <RefreshCw className={`w-3.5 h-3.5 ${isReOCRing ? 'animate-spin text-indigo-600' : ''}`} />
                    ...
                    <button
                      ...
                      disabled={isSaving}
                      className="flex items-center gap-1.5 px-4 py-1.5 text-xs font-semibold text-white bg-indigo-600 hover:bg-indigo-700 rounded-full shadow-xs transition-all disabled:opacity-50"
                    >
                      {isSaving ? (
