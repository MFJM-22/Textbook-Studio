...
- **Weekly Lesson Editor:** Edit lesson topics, table sections, subheadings, summary points, and review questions.
...
- **Styling:** Tailwind CSS (Clean, ultra-modern light aesthetic with refined typography)
- **Icons:** Lucide React
- **AI Engine:** Google Gemini AI API (`@google/genai`)
- **Document Generators:** `docx` (Word processing), `html2pdf.js` / `jsPDF` (PDF generation)
